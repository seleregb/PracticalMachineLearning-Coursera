...
In order to conduct to predictive modelling, I selected the RandomForest algorithm because of its efficiency in selecting the important variables and is robust to correlated covariate and outliers. I have opted to use 5-fold cross validation when applying the algorithm.
